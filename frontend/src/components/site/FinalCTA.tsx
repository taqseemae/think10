  ...
  return (
    <Section className="relative overflow-hidden bg-[#030914] py-32 lg:py-48 isolate border-t border-white/5">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center flex flex-col items-center">
        ...
        <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl mb-12 shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] transition-all hover:bg-white/10 hover:scale-105 hover:border-[color:var(--t10-emerald)]/30 cursor-default group">
        ...
        {/* Refined Subtitle */}
        <p className="text-lg sm:text-2xl text-white/60 max-w-3xl mx-auto mb-14 leading-relaxed font-light">
