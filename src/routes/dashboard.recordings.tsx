...
export const Route = createFileRoute("/dashboard/recordings")({
  component: DashboardRecordings,
});

function DashboardRecordings() {
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          ...
          <p className="text-neutral-500 text-sm mt-1">Review all your past strategy sessions, advisor notes, and video recordings.</p>
        </div>
      </div>
              ...
              <li key={booking.id} className="p-6 transition-colors hover:bg-neutral-50 flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0 space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-neutral-500 font-medium mt-1">Advisor: {booking.expertName || "Advisor"}</p>
                  </div>
                  ...
                  {booking.report ? (
                    <div className="rounded-xl bg-[color:var(--t10-mint)]/40 p-4 border border-emerald-100 space-y-3">
                      <h5 className="font-bold text-[color:var(--t10-navy)] text-sm">Advisor Report Summary</h5>
                    ...
                    <div className="rounded-xl bg-neutral-100 p-4 border border-neutral-200 text-sm text-neutral-500">
                      The advisor is currently drafting your consultation report. Check back soon.
                    </div>
                  )}
                </div>
              </li>
