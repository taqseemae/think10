...
export const Route = createFileRoute("/consultant/recordings")({
  component: ConsultantRecordings,
});

function ConsultantRecordings() {
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          ...
          <p className="text-neutral-500 text-sm mt-1">Review all your past sessions, AI generated notes, and video recordings.</p>
        </div>
      </div>
              ...
              <li key={booking.id} className="p-6 transition-colors hover:bg-neutral-50 flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0 space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-neutral-500 font-medium mt-1">Client: {booking.userName || booking.userEmail || "Client User"}</p>
                  </div>
