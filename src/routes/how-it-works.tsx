...
export const Route = createFileRoute("/how-it-works")({
  ...
  head: () => ({
    meta: [
      { title: "How Think10 works | AI + human business advisory" },
      {
        name: "description",
        content:
          "See how Think10 combines Zyne (AI) and vetted UAE experts to turn founder questions into decisions and action.",
      },
      { property: "og:title", content: "How Think10 works" },
