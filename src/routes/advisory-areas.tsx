...
export const Route = createFileRoute("/advisory-areas")({
  component: Page,
  head: () => ({
    meta: [
      { title: "Advisory areas | UAE retail and e-commerce" },
      {
        name: "description",
        content:
          "Eight advisory areas covering the decisions UAE retail, e-commerce, marketplace and product founders actually face.",
      },
      { property: "og:title", content: "Advisory areas" },
      { property: "og:url", content: "/advisory-areas" },
    ],
    links: [{ rel: "canonical", href: "/advisory-areas" }],
  }),
});
