...
export const Route = createFileRoute("/plans")({
  ...
  head: () => ({
    meta: [
      { title: "Plans & pricing | Think10" },
      {
        name: "description",
        content:
          "Start with Zyne for free, book one-off expert sessions, or move to Think10 Membership and Premium Advisory for continuity.",
      },
      { property: "og:title", content: "Plans & pricing" },
