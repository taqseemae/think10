...
export const Route = createFileRoute("/command-centre")({
  ...
  head: () => ({
    meta: [
      { title: "Command Centre | Your business advisory workspace" },
      {
        name: "description",
        content:
          "The Think10 Command Centre keeps your AI chats, expert sessions, decisions, actions and documents in one connected workspace.",
      },
      { property: "og:title", content: "Think10 Command Centre" },
      { property: "og:url", content: "/command-centre" },
    ],
    links: [{ rel: "canonical", href: "/command-centre" }],
  }),
});
