...
export const Route = createFileRoute("/premium-advisory")({
  component: Page,
  head: () => ({
    meta: [
      { title: "Premium Advisory | Think10" },
      {
        name: "description",
        content:
          "Ongoing lead advisor plus expert bench for UAE founders scaling beyond AED 5M revenue.",
      },
      { property: "og:title", content: "Premium Advisory" },
      { property: "og:url", content: "/premium-advisory" },
    ],
    links: [{ rel: "canonical", href: "/premium-advisory" }],
  }),
});
