...
export const Route = createFileRoute("/resources")({
  ...
  head: () => ({
    meta: [
      { title: "Resources | UAE retail & e-commerce founder guides" },
      {
        name: "description",
        content:
          "Practical guides on launching, marketplaces, inventory, pricing, brand and automation for UAE retail and e-commerce founders.",
      },
