...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About Think10 | UAE founder advisory system" },
      {
        name: "description",
        content:
          "Think10 is built for UAE founders in retail, e-commerce, marketplaces and product businesses — combining Zyne AI with vetted human experts.",
      },
      { property: "og:title", content: "About Think10" },
