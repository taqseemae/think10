    ...
    <div className="space-y-6 animate-fade-in max-w-2xl">
      ...
      <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 space-y-3">
        ...
        <p className="text-xs text-amber-700 leading-relaxed">
          The Google account you connect here will be the "host" of all booking events. It will appear as the organizer in Google Calendar invites. Use your Google Workspace account <strong>info@think10.ae</strong> to authorize meeting creation.
        </p>
        <p className="text-xs text-amber-700 leading-relaxed">
