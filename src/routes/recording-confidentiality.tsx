...
export const Route = createFileRoute("/recording-confidentiality")({
  component: () => (
    <LegalPage
  ...
  head: () => ({
    meta: [
      { title: "Recording & Confidentiality | Think10" },
      {
        name: "description",
        content: "How Think10 handles session recordings and confidentiality.",
      },
    ],
    links: [{ rel: "canonical", href: "/recording-confidentiality" }],
  }),
});
