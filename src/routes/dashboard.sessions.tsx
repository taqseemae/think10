              ...
              <div className="space-y-4 text-xs">
                ...
                <div className="grid grid-cols-2 gap-3 border-t border-[color:var(--t10-border)] pt-4 text-xs font-semibold">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 rounded-lg bg-[color:var(--t10-navy)] px-4 py-2.5 text-xs font-bold text-white hover:bg-neutral-800 transition-colors shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 rounded-lg border border-[color:var(--t10-border)] bg-neutral-100 px-4 py-2.5 text-xs font-bold text-[color:var(--t10-navy)] hover:bg-neutral-200 transition-colors"
                  >
