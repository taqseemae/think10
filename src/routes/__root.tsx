...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Think10 | AI + Human Business Advisory for UAE Founders" },
      {
        name: "description",
        content:
          "Get 24/7 business guidance from Zyne and practical support from vetted UAE retail and e-commerce experts. Start with AI, book one session, or choose ongoing advisory.",
      },
      { name: "author", content: "Think10" },
      { property: "og:site_name", content: "Think10" },
      { property: "og:title", content: "Think10 | AI + Human Business Advisory for UAE Founders" },
      {
        property: "og:description",
        content: "AI + human business advisory for UAE retail and e-commerce founders.",
      },
